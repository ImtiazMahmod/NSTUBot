...
class CampusDialog extends ComponentDialog {
    ...
    async firstStep(step) {
        ...
        return await step.prompt(CONFIRM_PROMPT, 'Would you like to know our campus?', ['yes', 'no']);
    }
    ...
    async getName(step) {
        ...
        if (step.result === true) {
            return await step.prompt(TEXT_PROMPT, 'In what do you want to know??');
    ...
    async finalStep(step) {
        ...
        } else if ((step.context.activity.text.toLowerCase() === 'cste') || (step.context.activity.text.toLowerCase() === 'cse')) {
            await step.context.sendActivity('Go to Official Site: https://nstu.edu.bd/department/cste/');
        } else if (step.context.activity.text.toLowerCase() === 'eee') {
            await step.context.sendActivity('Go to Official Site: https://nstu.edu.bd/department/eee/');
        } else {
            await step.context.sendActivity('Not match any department!');
        }
...
module.exports.CampusDialog = CampusDialog;
